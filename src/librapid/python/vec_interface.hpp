...
py::class_<librapid::Vec2i>(module,
...
def(py::init<int64_t, int64_t>(), py::arg("x"), py::arg("y")
...
const librapid::Vec2i& vec, int64_t

index) {
return vec[index]; })
.def("__setitem__", [](

librapid::Vec2i& vec, int64_t
...
const librapid::Vec2i& lhs, int64_t
...
py::class_<librapid::Vec2f>(module,
...
const librapid::Vec2f& vec, int64_t

index) {
return vec[index]; })
.def("__setitem__", [](

librapid::Vec2f& vec, int64_t
...
const librapid::Vec2f& lhs, int64_t
...
py::class_<librapid::Vec2d>(module,
...
const librapid::Vec2d& vec, int64_t

index) {
return vec[index]; })
.def("__setitem__", [](

librapid::Vec2d& vec, int64_t
...
const librapid::Vec2d& lhs, int64_t
...
py::class_<librapid::Vec3i>(module,
...
def(py::init<int64_t, int64_t, int64_t>(), py::arg("x"), py::arg("y")
...
const librapid::Vec3i& vec, int64_t

index) {
return vec[index]; })
.def("__setitem__", [](

librapid::Vec3i& vec, int64_t
...
const librapid::Vec3i& lhs, int64_t
...
py::class_<librapid::Vec3f>(module,
...
const librapid::Vec3f& vec, int64_t

index) {
return vec[index]; })
.def("__setitem__", [](

librapid::Vec3f& vec, int64_t
...
const librapid::Vec3f& lhs, int64_t
...
py::class_<librapid::Vec3d>(module,
...
const librapid::Vec3d& vec, int64_t

index) {
return vec[index]; })
.def("__setitem__", [](

librapid::Vec3d& vec, int64_t
...
const librapid::Vec3d& lhs, int64_t
...
py::class_<librapid::Vec4i>(module,
...
def(py::init<int64_t, int64_t, int64_t, int64_t>(), py::arg("x"), py::arg("y")

= 0, py::arg("z") = 0, py::arg("w") = 0)
.
def (py::init<const librapid::Vec4i>())

.def("__getitem__", [](

const librapid::Vec4i& vec, int64_t

index) {
return vec[index]; })
.def("__setitem__", [](

librapid::Vec4i& vec, int64_t
...
const librapid::Vec4i& lhs, int64_t
...
py::class_<librapid::Vec4f>(module,
...
const librapid::Vec4f& vec, int64_t

index) {
return vec[index]; })
.def("__setitem__", [](

librapid::Vec4f& vec, int64_t
...
const librapid::Vec4f& lhs, int64_t
...
py::class_<librapid::Vec4d>(module,
...
def(py::init<double, double, double, double>(), py::arg("x"), py::arg("y")
...
const librapid::Vec4d& vec, int64_t

index) {
return vec[index]; })
.def("__setitem__", [](

librapid::Vec4d& vec, int64_t
...
const librapid::Vec4d& lhs, int64_t

...
py::class_<librapid::Vec2f>(module, "Vec2f")
	...
	.def("__setitem__", [](librapid::Vec2f &vec, int64_t index, float val) { vec[index] = val; })
	.def("__setitem__", [](librapid::Vec2f &vec, int64_t index, float val) { vec[index] = val; })

	.def("__neg__", [](const librapid::Vec2f &lhs) { return -lhs; })
	...
	.def("xz", &librapid::Vec2f::xz)
	.def("zx", &librapid::Vec2f::zx)
	.def("yz", &librapid::Vec2f::yz)
	.def("zy", &librapid::Vec2f::zy)
	...
	.def("xyw", &librapid::Vec2f::xyw)
	.def("xwy", &librapid::Vec2f::xwy)
	.def("yxw", &librapid::Vec2f::yxw)
	.def("ywx", &librapid::Vec2f::ywx)
	.def("wxy", &librapid::Vec2f::wxy)
	.def("wyx", &librapid::Vec2f::wyx)
	.def("xzw", &librapid::Vec2f::xzw)
	.def("xwz", &librapid::Vec2f::xwz)
	.def("zxw", &librapid::Vec2f::zxw)
	.def("zwx", &librapid::Vec2f::zwx)
	.def("wxz", &librapid::Vec2f::wxz)
	.def("wzx", &librapid::Vec2f::wzx)
	.def("yzw", &librapid::Vec2f::yzw)
	.def("ywz", &librapid::Vec2f::ywz)
	.def("zyw", &librapid::Vec2f::zyw)
	.def("zwy", &librapid::Vec2f::zwy)
	.def("wyz", &librapid::Vec2f::wyz)
	.def("wzy", &librapid::Vec2f::wzy)

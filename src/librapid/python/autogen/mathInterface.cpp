...
void init_math(py::module &module) {
	...
	module.def("csc", [](const librapid::half & val) { return lrc::csc(val); }, py::arg("val"));
	module.def("sec", [](const librapid::half & val) { return lrc::sec(val); }, py::arg("val"));
	module.def("cot", [](const librapid::half & val) { return lrc::cot(val); }, py::arg("val"));
	module.def("acsc", [](const librapid::half & val) { return lrc::acsc(val); }, py::arg("val"));
	module.def("asec", [](const librapid::half & val) { return lrc::asec(val); }, py::arg("val"));
	module.def("acot", [](const librapid::half & val) { return lrc::acot(val); }, py::arg("val"));

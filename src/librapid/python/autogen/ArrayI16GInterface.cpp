...
py::class_<librapid::ArrayI16G>(module, "ArrayI16G")
	...
	#endif // LIBRAPID_HAS_CUDA
	.def("cast_ArrayI16G", [](const librapid::ArrayI16G & this_) { return this_.cast<typename librapid::internal::traits<librapid::ArrayMPZ>::Scalar>(); })
	...
	#endif // LIBRAPID_HAS_CUDA
	.def("cast_ArrayI16G", [](const librapid::ArrayI16G & this_) { return this_.cast<typename librapid::internal::traits<librapid::ArrayMPF>::Scalar>(); })
	...
	#endif // LIBRAPID_HAS_CUDA
	.def("cast_ArrayI16G", [](const librapid::ArrayI16G & this_) { return this_.cast<typename librapid::internal::traits<librapid::ArrayMPQ>::Scalar>(); })

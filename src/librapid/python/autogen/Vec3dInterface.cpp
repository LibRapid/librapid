...
py::class_<librapid::Vec3d>(module, "Vec3d")
	...
	.def("__neg__", [](const librapid::Vec3d &lhs) { return -lhs; })
	...
	.def("cross", [](const librapid::Vec3d &lhs, const librapid::Vec3d &rhs) { return lhs.cross(rhs); }, py::arg("other"))
	...
	.def("xz", &librapid::Vec3d::xz)
	.def("zx", &librapid::Vec3d::zx)
	.def("yz", &librapid::Vec3d::yz)
	.def("zy", &librapid::Vec3d::zy)
	...
	.def("xyw", &librapid::Vec3d::xyw)
	.def("xwy", &librapid::Vec3d::xwy)
	.def("yxw", &librapid::Vec3d::yxw)
	.def("ywx", &librapid::Vec3d::ywx)
	.def("wxy", &librapid::Vec3d::wxy)
	.def("wyx", &librapid::Vec3d::wyx)
	.def("xzw", &librapid::Vec3d::xzw)
	.def("xwz", &librapid::Vec3d::xwz)
	.def("zxw", &librapid::Vec3d::zxw)
	.def("zwx", &librapid::Vec3d::zwx)
	.def("wxz", &librapid::Vec3d::wxz)
	.def("wzx", &librapid::Vec3d::wzx)
	.def("yzw", &librapid::Vec3d::yzw)
	.def("ywz", &librapid::Vec3d::ywz)
	.def("zyw", &librapid::Vec3d::zyw)
	.def("zwy", &librapid::Vec3d::zwy)
	.def("wyz", &librapid::Vec3d::wyz)
	.def("wzy", &librapid::Vec3d::wzy)

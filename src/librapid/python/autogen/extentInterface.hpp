py::class_<librapid::Extent>(module, "Extent")
	...
	.def("swivel", [](const librapid::Extent & this_, const librapid::Extent & order) { return this_.swivel(order); }, py::arg("order"))
	.def("swivelInplace", [](librapid::Extent & this_, const librapid::Extent & order) { this_.swivelInplace(order); }, py::arg("order"))

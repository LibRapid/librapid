...
py::class_<librapid::Vec2d>(module, "Vec2d")
	...
	.def("xz", &librapid::Vec2d::xz)
	.def("zx", &librapid::Vec2d::zx)
	.def("yz", &librapid::Vec2d::yz)
	.def("zy", &librapid::Vec2d::zy)
	...
	.def("xyw", &librapid::Vec2d::xyw)
	.def("xwy", &librapid::Vec2d::xwy)
	.def("yxw", &librapid::Vec2d::yxw)
	.def("ywx", &librapid::Vec2d::ywx)
	.def("wxy", &librapid::Vec2d::wxy)
	.def("wyx", &librapid::Vec2d::wyx)
	.def("xzw", &librapid::Vec2d::xzw)
	.def("xwz", &librapid::Vec2d::xwz)
	.def("zxw", &librapid::Vec2d::zxw)
	.def("zwx", &librapid::Vec2d::zwx)
	.def("wxz", &librapid::Vec2d::wxz)
	.def("wzx", &librapid::Vec2d::wzx)
	.def("yzw", &librapid::Vec2d::yzw)
	.def("ywz", &librapid::Vec2d::ywz)
	.def("zyw", &librapid::Vec2d::zyw)
	.def("zwy", &librapid::Vec2d::zwy)
	.def("wyz", &librapid::Vec2d::wyz)
	.def("wzy", &librapid::Vec2d::wzy)

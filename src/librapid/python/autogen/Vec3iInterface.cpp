...
py::class_<librapid::Vec3i>(module, "Vec3i")
	.def(py::init<>())
	.def(py::init<int32_t, int32_t, int32_t>(), py::arg("x"), py::arg("y") = 0, py::arg("z") = 0)
	.def(py::init<const librapid::Vec3i>())

	.def("__getitem__", [](const librapid::Vec3i &vec, int64_t index) { return vec[index]; })
	.def("__setitem__", [](librapid::Vec3i &vec, int64_t index, int32_t val) { vec[index] = val; })
	.def("__setitem__", [](librapid::Vec3i &vec, int64_t index, int32_t val) { vec[index] = val; })

	.def("__neg__", [](const librapid::Vec3i &lhs) { return -lhs; })

	.def("__add__", [](const librapid::Vec3i &lhs, int32_t rhs) { return lhs + rhs; })
	.def("__sub__", [](const librapid::Vec3i &lhs, int32_t rhs) { return lhs - rhs; })
	.def("__mul__", [](const librapid::Vec3i &lhs, int32_t rhs) { return lhs * rhs; })
	.def("__truediv__", [](const librapid::Vec3i &lhs, int32_t rhs) { return lhs / rhs; })
	...
	.def("__iadd__", [](librapid::Vec3i &lhs, int32_t rhs) { lhs += rhs; })
	.def("__isub__", [](librapid::Vec3i &lhs, int32_t rhs) { lhs -= rhs; })
	.def("__imul__", [](librapid::Vec3i &lhs, int32_t rhs) { lhs *= rhs; })
	.def("__itruediv__", [](librapid::Vec3i &lhs, int32_t rhs) { lhs /= rhs; })
	...
	.def("cross", [](const librapid::Vec3i &lhs, const librapid::Vec3i &rhs) { return lhs.cross(rhs); }, py::arg("other"))
	...
	.def("xz", &librapid::Vec3i::xz)
	.def("zx", &librapid::Vec3i::zx)
	.def("yz", &librapid::Vec3i::yz)
	.def("zy", &librapid::Vec3i::zy)
	...
	.def("xyw", &librapid::Vec3i::xyw)
	.def("xwy", &librapid::Vec3i::xwy)
	.def("yxw", &librapid::Vec3i::yxw)
	.def("ywx", &librapid::Vec3i::ywx)
	.def("wxy", &librapid::Vec3i::wxy)
	.def("wyx", &librapid::Vec3i::wyx)
	.def("xzw", &librapid::Vec3i::xzw)
	.def("xwz", &librapid::Vec3i::xwz)
	.def("zxw", &librapid::Vec3i::zxw)
	.def("zwx", &librapid::Vec3i::zwx)
	.def("wxz", &librapid::Vec3i::wxz)
	.def("wzx", &librapid::Vec3i::wzx)
	.def("yzw", &librapid::Vec3i::yzw)
	.def("ywz", &librapid::Vec3i::ywz)
	.def("zyw", &librapid::Vec3i::zyw)
	.def("zwy", &librapid::Vec3i::zwy)
	.def("wyz", &librapid::Vec3i::wyz)
	.def("wzy", &librapid::Vec3i::wzy)

...
py::class_<librapid::Vec4f>(module, "Vec4f")
	...
	.def("__setitem__", [](librapid::Vec4f &vec, int64_t index, float val) { vec[index] = val; })
	.def("__setitem__", [](librapid::Vec4f &vec, int64_t index, float val) { vec[index] = val; })

	.def("__neg__", [](const librapid::Vec4f &lhs) { return -lhs; })
	...
	.def("xz", &librapid::Vec4f::xz)
	.def("zx", &librapid::Vec4f::zx)
	.def("yz", &librapid::Vec4f::yz)
	.def("zy", &librapid::Vec4f::zy)
	...
	.def("xyw", &librapid::Vec4f::xyw)
	.def("xwy", &librapid::Vec4f::xwy)
	.def("yxw", &librapid::Vec4f::yxw)
	.def("ywx", &librapid::Vec4f::ywx)
	.def("wxy", &librapid::Vec4f::wxy)
	.def("wyx", &librapid::Vec4f::wyx)
	.def("xzw", &librapid::Vec4f::xzw)
	.def("xwz", &librapid::Vec4f::xwz)
	.def("zxw", &librapid::Vec4f::zxw)
	.def("zwx", &librapid::Vec4f::zwx)
	.def("wxz", &librapid::Vec4f::wxz)
	.def("wzx", &librapid::Vec4f::wzx)
	.def("yzw", &librapid::Vec4f::yzw)
	.def("ywz", &librapid::Vec4f::ywz)
	.def("zyw", &librapid::Vec4f::zyw)
	.def("zwy", &librapid::Vec4f::zwy)
	.def("wyz", &librapid::Vec4f::wyz)
	.def("wzy", &librapid::Vec4f::wzy)

...
py::class_<librapid::Vec3f>(module, "Vec3f")
	...
	.def("__setitem__", [](librapid::Vec3f &vec, int64_t index, float val) { vec[index] = val; })
	.def("__setitem__", [](librapid::Vec3f &vec, int64_t index, float val) { vec[index] = val; })

	.def("__neg__", [](const librapid::Vec3f &lhs) { return -lhs; })
	...
	.def("cross", [](const librapid::Vec3f &lhs, const librapid::Vec3f &rhs) { return lhs.cross(rhs); }, py::arg("other"))
	...
	.def("xz", &librapid::Vec3f::xz)
	.def("zx", &librapid::Vec3f::zx)
	.def("yz", &librapid::Vec3f::yz)
	.def("zy", &librapid::Vec3f::zy)
	...
	.def("xyw", &librapid::Vec3f::xyw)
	.def("xwy", &librapid::Vec3f::xwy)
	.def("yxw", &librapid::Vec3f::yxw)
	.def("ywx", &librapid::Vec3f::ywx)
	.def("wxy", &librapid::Vec3f::wxy)
	.def("wyx", &librapid::Vec3f::wyx)
	.def("xzw", &librapid::Vec3f::xzw)
	.def("xwz", &librapid::Vec3f::xwz)
	.def("zxw", &librapid::Vec3f::zxw)
	.def("zwx", &librapid::Vec3f::zwx)
	.def("wxz", &librapid::Vec3f::wxz)
	.def("wzx", &librapid::Vec3f::wzx)
	.def("yzw", &librapid::Vec3f::yzw)
	.def("ywz", &librapid::Vec3f::ywz)
	.def("zyw", &librapid::Vec3f::zyw)
	.def("zwy", &librapid::Vec3f::zwy)
	.def("wyz", &librapid::Vec3f::wyz)
	.def("wzy", &librapid::Vec3f::wzy)

...
py::class_<librapid::Vec2i>(module, "Vec2i")
	...
	.def("xz", &librapid::Vec2i::xz)
	.def("zx", &librapid::Vec2i::zx)
	.def("yz", &librapid::Vec2i::yz)
	.def("zy", &librapid::Vec2i::zy)
	...
	.def("xyw", &librapid::Vec2i::xyw)
	.def("xwy", &librapid::Vec2i::xwy)
	.def("yxw", &librapid::Vec2i::yxw)
	.def("ywx", &librapid::Vec2i::ywx)
	.def("wxy", &librapid::Vec2i::wxy)
	.def("wyx", &librapid::Vec2i::wyx)
	.def("xzw", &librapid::Vec2i::xzw)
	.def("xwz", &librapid::Vec2i::xwz)
	.def("zxw", &librapid::Vec2i::zxw)
	.def("zwx", &librapid::Vec2i::zwx)
	.def("wxz", &librapid::Vec2i::wxz)
	.def("wzx", &librapid::Vec2i::wzx)
	.def("yzw", &librapid::Vec2i::yzw)
	.def("ywz", &librapid::Vec2i::ywz)
	.def("zyw", &librapid::Vec2i::zyw)
	.def("zwy", &librapid::Vec2i::zwy)
	.def("wyz", &librapid::Vec2i::wyz)
	.def("wzy", &librapid::Vec2i::wzy)

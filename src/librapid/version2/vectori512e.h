	...
	public:
		...
		Vec16b(bool b0, bool b1, bool b2, bool b3, bool b4, bool b5, bool b6, bool b7,
			...
			*this = Vec512b(
					...
					Vec8i(-(int) b8, -(int) b9, -(int) b10, -(int) b11, -(int) b12, -(int) b13, -(int) b14,
						  -(int) b15));
		}
...
// blend vectors Vec8q
	...
	static inline Vec16ui blend16(Vec16ui const a, Vec16ui const b) {
		return Vec16ui(
				blend16<i0, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12, i13, i14, i15>(Vec16i(a), Vec16i(b)));
	}
		...
		if constexpr (imax - imin <= 15) {
			...
			if constexpr (imax > 15) {
				...
				return permute16<i0 - imin, i1 - imin, i2 - imin, i3 - imin, i4 - imin, i5 - imin, i6 - imin, i7 - imin,
						i8 - imin, i9 - imin, i10 - imin, i11 - imin, i12 - imin, i13 - imin, i14 - imin, i15 - imin>(
						b);
			}
		}

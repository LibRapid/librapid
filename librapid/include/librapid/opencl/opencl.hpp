...
#if defined(LIBRAPID_GNU) || defined(LIBRAPID_CLANG)
...
#define CL_HPP_INIT_CL_EXT_FCN_PTR_(name)                                                          \
	if (!pfn_##name) { pfn_##name = (PFN_##name)clGetExtensionFunctionAddress(#name); }
...
#	endif // CL_HPP_TARGET_OPENCL_VERSION >= 210
	...
	CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clCreateCommandBufferKHR pfn_clCreateCommandBufferKHR =
	  nullptr;
	CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clFinalizeCommandBufferKHR pfn_clFinalizeCommandBufferKHR =
	  nullptr;
	CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clRetainCommandBufferKHR pfn_clRetainCommandBufferKHR =
	  nullptr;
	CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clReleaseCommandBufferKHR pfn_clReleaseCommandBufferKHR =
	  nullptr;
	CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clGetCommandBufferInfoKHR pfn_clGetCommandBufferInfoKHR =
	  nullptr;
	CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clEnqueueCommandBufferKHR pfn_clEnqueueCommandBufferKHR =
	  nullptr;
	...
	CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clCommandNDRangeKernelKHR pfn_clCommandNDRangeKernelKHR =
	  nullptr;
#endif /* cl_khr_command_buffer */
	...
	namespace detail {
		...
		inline cl_int getInfoHelper(Func f, cl_uint name, vector<vector<unsigned char>> *param,
									int) {
		...
		inline cl_int getInfoHelper(Func f, cl_uint name, string *param, long) {
			...
			if (required > 0) {
				...
				err = f(name, required, value.data(), nullptr);
				if (err != CL_SUCCESS) { return err; }
				if (param) { param->assign(value.begin(), value.end() - 1); }
			} else if (param) {
				param->assign("");
			}
			return CL_SUCCESS;
...
#	if defined(CL_DEVICE_IMAGE_BASE_ADDRESS_ALIGNMENT_KHR)
		CL_HPP_DECLARE_PARAM_TRAITS_(cl_device_info, CL_DEVICE_IMAGE_BASE_ADDRESS_ALIGNMENT_KHR,
									 cl_uint)
#	endif
#endif // CL_HPP_TARGET_OPENCL_VERSION < 200
...
#	if defined(CL_DEVICE_INTEGER_DOT_PRODUCT_ACCELERATION_PROPERTIES_8BIT_KHR)
		...
		CL_HPP_DECLARE_PARAM_TRAITS_(
		  cl_device_info, CL_DEVICE_INTEGER_DOT_PRODUCT_ACCELERATION_PROPERTIES_4x8BIT_PACKED_KHR,
		  cl_device_integer_dot_product_acceleration_properties_khr)
#	endif // defined(CL_DEVICE_INTEGER_DOT_PRODUCT_ACCELERATION_PROPERTIES_8BIT_KHR)
		...
		CL_HPP_DECLARE_PARAM_TRAITS_(cl_device_info, CL_DEVICE_GLOBAL_MEM_CHANNEL_BANKS_AMD,
									 cl_uint)
#endif
#ifdef CL_DEVICE_GLOBAL_MEM_CHANNEL_BANK_WIDTH_AMD
		CL_HPP_DECLARE_PARAM_TRAITS_(cl_device_info, CL_DEVICE_GLOBAL_MEM_CHANNEL_BANK_WIDTH_AMD,
									 cl_uint)
#endif
#ifdef CL_DEVICE_LOCAL_MEM_SIZE_PER_COMPUTE_UNIT_AMD
		CL_HPP_DECLARE_PARAM_TRAITS_(cl_device_info, CL_DEVICE_LOCAL_MEM_SIZE_PER_COMPUTE_UNIT_AMD,
									 cl_uint)
#endif
		...
		CL_HPP_DECLARE_PARAM_TRAITS_(cl_device_info, CL_DEVICE_SCHEDULING_CONTROLS_CAPABILITIES_ARM,
									 cl_bitfield)
#endif
#ifdef CL_DEVICE_SUPPORTED_REGISTER_ALLOCATIONS_ARM
		CL_HPP_DECLARE_PARAM_TRAITS_(cl_device_info, CL_DEVICE_SUPPORTED_REGISTER_ALLOCATIONS_ARM,
									 vector<cl_uint>)
#endif
...
#if defined(cl_khr_command_buffer)
		CL_HPP_DECLARE_PARAM_TRAITS_(cl_device_info, CL_DEVICE_COMMAND_BUFFER_CAPABILITIES_KHR,
									 cl_device_command_buffer_capabilities_khr)
		CL_HPP_DECLARE_PARAM_TRAITS_(cl_device_info,
									 CL_DEVICE_COMMAND_BUFFER_REQUIRED_QUEUE_PROPERTIES_KHR,
									 cl_command_buffer_properties_khr)
		CL_HPP_DECLARE_PARAM_TRAITS_(cl_command_buffer_info_khr, CL_COMMAND_BUFFER_QUEUES_KHR,
									 cl::vector<CommandQueue>)
		CL_HPP_DECLARE_PARAM_TRAITS_(cl_command_buffer_info_khr, CL_COMMAND_BUFFER_NUM_QUEUES_KHR,
									 cl_uint)
		CL_HPP_DECLARE_PARAM_TRAITS_(cl_command_buffer_info_khr,
									 CL_COMMAND_BUFFER_REFERENCE_COUNT_KHR, cl_uint)
		CL_HPP_DECLARE_PARAM_TRAITS_(cl_command_buffer_info_khr, CL_COMMAND_BUFFER_STATE_KHR,
		...
		CL_HPP_DECLARE_PARAM_TRAITS_(cl_mutable_command_info_khr,
									 CL_MUTABLE_COMMAND_COMMAND_BUFFER_KHR, CommandBufferKhr)
		CL_HPP_DECLARE_PARAM_TRAITS_(cl_mutable_command_info_khr,
									 CL_MUTABLE_COMMAND_COMMAND_TYPE_KHR, cl_command_type)
		CL_HPP_DECLARE_PARAM_TRAITS_(cl_mutable_command_info_khr,
									 CL_MUTABLE_DISPATCH_PROPERTIES_ARRAY_KHR,
									 cl::vector<cl_ndrange_kernel_command_properties_khr>)
		CL_HPP_DECLARE_PARAM_TRAITS_(cl_mutable_command_info_khr, CL_MUTABLE_DISPATCH_KERNEL_KHR,
									 cl_kernel)
		CL_HPP_DECLARE_PARAM_TRAITS_(cl_mutable_command_info_khr,
		...
		CL_HPP_DECLARE_PARAM_TRAITS_(cl_mutable_command_info_khr,
									 ...
									 cl::vector<size_type>)
		CL_HPP_DECLARE_PARAM_TRAITS_(cl_mutable_command_info_khr,
									 CL_MUTABLE_DISPATCH_LOCAL_WORK_SIZE_KHR, cl::vector<size_type>)
#endif /* cl_khr_command_buffer_mutable_dispatch */
...
#	endif // CL_HPP_MINIMUM_OPENCL_VERSION < 120
	...
	using BuildLogType = vector<
	  std::pair<cl::Device, typename detail::param_traits<detail::cl_program_build_info,
...
#	endif
	...
	private:
		...
		struct ImageRequirementsInfo {
			ImageRequirementsInfo(cl_mem_flags f, const cl_mem_properties *properties,
								  const ImageFormat *format, const cl_image_desc *desc) {
				flags		 = f;
...
#	endif
	...
	public:
		 ...
		 */
		Context(const vector<Device> &devices, const cl_context_properties *properties = nullptr,
		 ...
		 *  Wraps clCreateContext().
		 */
		Context(const Device &device, const cl_context_properties *properties = nullptr,
				void(CL_CALLBACK *notifyFptr)(const char *, const void *, size_type,
											  void *) = nullptr,
				void *data = nullptr, cl_int *err = nullptr) {
			cl_int error;
		 ...
		 */
		Context(cl_device_type type, const cl_context_properties *properties = nullptr,
				void(CL_CALLBACK *notifyFptr)(const char *, const void *, size_type,
											  void *) = nullptr,
				void *data = nullptr, cl_int *err = nullptr) {
			cl_int error;
...
#	if defined(CL_HPP_ENABLE_EXCEPTIONS)
					...
					// has no devices of type We do error checking next anyway, and can throw there
					// if needed
#	endif
				...
				if (platform_id == 0) {
					...
					if (err != nullptr) { *err = CL_DEVICE_NOT_FOUND; }
					return;
				}
		...
		static Context getDefault(cl_int *err = nullptr) {
			std::call_once(default_initialized_, makeDefault);
			detail::errHandler(default_error_);
			if (err != nullptr) { *err = default_error_; }
			return default_;
		}
		...
		cl_int getSupportedImageFormats(cl_mem_flags flags, cl_mem_object_type type,
			...
			cl_int err =
			  ::clGetSupportedImageFormats(object_, flags, type, 0, nullptr, &numEntries);
			if (err != CL_SUCCESS) {
...
#if defined(cl_ext_image_requirements_info)
		template<typename T>
		cl_int getImageRequirementsInfoExt(cl_image_requirements_info_ext name, T *param,
										   cl_mem_flags flags				   = 0,
		 ...
		 */
		cl_int setDestructorCallback(void(CL_CALLBACK *pfn_notify)(cl_context, void *),
									 void *user_data = nullptr) {
			return detail::errHandler(
			  ::clSetContextDestructorCallback(object_, pfn_notify, user_data),
	 ...
	 * similar objects, care must be taken when using with smart pointers. The allocator should not
	 * be used to construct a unique_ptr if we are using coarse-grained SVM mode because the
	 * coarse-grained management behaviour would behave incorrectly with respect to reference
	 * counting.
	 *
	...
	public:
		...
		const_pointer address(const_reference r) noexcept { return std::addressof(r); }
...
#	endif // #if !defined(CL_HPP_NO_STD_UNIQUE_PTR)
	...
	/*! \brief Vector alias to simplify contruction of fine-grained SVM containers that support
	 * platform atomics.
	 *
	 */
	template<class T>
	...
	public:
		 ...
		 */
		Buffer(const Context &context, cl_mem_flags flags, size_type size, void *host_ptr = nullptr,
			   cl_int *err = nullptr) {
			cl_int error;
		...
		Buffer(const Context &context, const vector<cl_mem_properties> &properties,
			...
			if (properties.empty()) {
				object_ =
				  ::clCreateBufferWithProperties(context(), nullptr, flags, size, host_ptr, &error);
			} else {
		 ...
		 *  \see Context::getDefault()
		 */
		Buffer(const vector<cl_mem_properties> &properties, cl_mem_flags flags, size_type size,
		...
		Buffer createSubBuffer(cl_mem_flags flags, cl_buffer_create_type buffer_create_type,
							   const void *buffer_create_info, cl_int *err = nullptr) {
			Buffer result;
			cl_int error;
			result.object_ =
...
#	endif
	...
	public:
		Image1DBuffer(const Context &context, cl_mem_flags flags, ImageFormat format,
			...
			object_ = ::clCreateImage(context(), flags, &format, &desc, nullptr, &error);
	...
	public:
		 ...
		 *  Wraps clCreateImage().
		 */
		Image2D(const Context &context, ImageFormat format, const Buffer &sourceBuffer,
				size_type width, size_type height, size_type row_pitch = 0, cl_int *err = nullptr) {
			cl_int error;
	...
	public:
		...
		Image2DGL(const Context &context, cl_mem_flags flags, cl_GLenum target, cl_GLint miplevel,
				  cl_GLuint texobj, cl_int *err = nullptr) {
			cl_int error;
	...
	public:
		Image2DArray(const Context &context, cl_mem_flags flags, ImageFormat format,
					 ...
					 size_type slicePitch, void *host_ptr = nullptr, cl_int *err = nullptr) {
			cl_int error;
	...
	public:
		...
		Image3D(const Context &context, cl_mem_flags flags, ImageFormat format, size_type width,
				...
				size_type slice_pitch = 0, void *host_ptr = nullptr, cl_int *err = nullptr) {
			cl_int error;
			bool useCreateImage;
...
#	endif // #if CL_HPP_TARGET_OPENCL_VERSION >= 210
		...
		cl_int setSVMPointers(const vector<void *> &pointerList) {
			return detail::errHandler(::clSetKernelExecInfo(object_,
		...
		void setSVMPointersHelper(std::array<void *, ArrayLength> &pointerList,
								  const pointer<T0, D> &t0, const pointer<T1, D> &t1, Ts &...ts) {
...
#	endif // #if !defined(CL_HPP_CL_1_2_DEFAULT_BUILD)
		 ...
		 * following errors: CL_INVALID_CONTEXT if context is not a valid context. CL_INVALID_VALUE
		 * if the length of devices is zero; or if the length of binaries does not match the length
		 * of devices; or if any entry in binaries is nullptr or has length 0. CL_INVALID_DEVICE if
		 * OpenCL devices listed in devices are not in the list of devices associated with context.
		 *   CL_INVALID_BINARY if an invalid program binary was encountered for any device.
		 * binaryStatus will return specific status for each device. CL_OUT_OF_HOST_MEMORY if there
		...
		Program(const Context &context, const vector<Device> &devices, const Binaries &binaries,
				vector<cl_int> *binaryStatus = nullptr, cl_int *err = nullptr) {
			cl_int error;
		...
		cl_int build(const char *options							   = nullptr,
					 void(CL_CALLBACK *notifyFptr)(cl_program, void *) = nullptr,
					 void *data										   = nullptr) const {
			cl_int buildError = ::clBuildProgram(object_, 0, nullptr, options, notifyFptr, data);
		...
		cl_int createKernels(vector<Kernel> *kernels) {
			...
			err = ::clCreateKernelsInProgram(object_, numKernels, value.data(), nullptr);
			if (err != CL_SUCCESS) {
				return detail::errHandler(err, __CREATE_KERNELS_IN_PROGRAM_ERR);
			}
...
#	endif // #if defined(CL_USE_DEPRECATED_OPENCL_2_2_APIS)
	...
	inline Program linkProgram(const Program &input1, const Program &input2,
		...
		cl_program prog =
		  ::clLinkProgram(ctx(), 0, nullptr, options, 2, programs, notifyFptr, data, &error_local);

		detail::errHandler(error_local, __COMPILE_PROGRAM_ERR);
		if (err != nullptr) { *err = error_local; }

		return Program(prog);
	}

	inline Program linkProgram(const vector<Program> &inputPrograms, const char *options = nullptr,
							   void(CL_CALLBACK *notifyFptr)(cl_program, void *) = nullptr,
							   void *data = nullptr, cl_int *err = nullptr) {
		cl_int error_local = CL_SUCCESS;
		Context ctx;
	...
	public:
		...
		/*!
		 * \brief Constructs a CommandQueue for an implementation defined device in the given
		 * context Will return an CL_INVALID_QUEUE_PROPERTIES error if CL_QUEUE_ON_DEVICE is
		 * specified.
		 */
		...
		CommandQueue(const Context &context, const Device &device,
					 cl_command_queue_properties properties = 0, cl_int *err = nullptr) {
			cl_int error;
			bool useWithProperties;
		...
		cl_int enqueueReadBuffer(const Buffer &buffer, cl_bool blocking, size_type offset,
								 size_type size, void *ptr, const vector<Event> *events = nullptr,
		...
		cl_int enqueueReadBufferRect(const Buffer &buffer, cl_bool blocking,
									 ...
									 const array<size_type, 2> &region, size_type buffer_row_pitch,
									 size_type buffer_slice_pitch, size_type host_row_pitch,
									 size_type host_slice_pitch, void *ptr,
									 const vector<Event> *events = nullptr,
									 Event *event				 = nullptr) const {
			return enqueueReadBufferRect(buffer,
										 blocking,
		...
		cl_int enqueueWriteBufferRect(const Buffer &buffer, cl_bool blocking,
									  ...
									  const vector<Event> *events = nullptr,
									  Event *event				  = nullptr) const {
			return enqueueWriteBufferRect(buffer,
										  blocking,
										  {buffer_offset[0], buffer_offset[1], 0},
										  {host_offset[0], host_offset[1], 0},
										  {region[0], region[1], 1},
		...
		cl_int enqueueCopyBufferRect(const Buffer &src, const Buffer &dst,
									 ...
									 const array<size_type, 2> &region, size_type src_row_pitch,
									 size_type src_slice_pitch, size_type dst_row_pitch,
									 size_type dst_slice_pitch,
									 const vector<Event> *events = nullptr,
									 Event *event				 = nullptr) const {
			return enqueueCopyBufferRect(src,
										 dst,
		...
		cl_int enqueueReadImage(const Image &image, cl_bool blocking,
								...
								size_type slice_pitch, void *ptr,
								const vector<Event> *events = nullptr,
								Event *event				= nullptr) const {
			cl_event tmp;
			cl_int err = detail::errHandler(
		...
		cl_int enqueueWriteImage(const Image &image, cl_bool blocking,
								 ...
								 const vector<Event> *events = nullptr,
								 Event *event				 = nullptr) const {
			return enqueueWriteImage(image,
									 blocking,
									 {origin[0], origin[1], 0},
									 {region[0], region[1], 1},
									 row_pitch,
		...
		cl_int
		enqueueCopyImage(const Image &src, const Image &dst, const array<size_type, 3> &src_origin,
		...
		cl_int
		enqueueCopyImage(const Image &src, const Image &dst, const array<size_type, 2> &src_origin,
						 const array<size_type, 2> &dst_origin, const array<size_type, 2> &region,
						 const vector<Event> *events = nullptr, Event *event = nullptr) const {
			return enqueueCopyImage(src,
									dst,
									{src_origin[0], src_origin[1], 0},
									{dst_origin[0], dst_origin[1], 0},
									{region[0], region[1], 1},
		...
		typename std::enable_if<std::is_same<T, cl_float4>::value ||
								...
								cl_int>::type
		enqueueFillImage(const Image &image, T fillColor, const array<size_type, 3> &origin,
						 const array<size_type, 3> &region, const vector<Event> *events = nullptr,
						 Event *event = nullptr) const {
			cl_event tmp;
			cl_int err = detail::errHandler(
			  ::clEnqueueFillImage(
		...
		typename std::enable_if<std::is_same<T, cl_float4>::value ||
								  ...
								  std::is_same<T, cl_uint4>::value,
								cl_int>::type
		enqueueFillImage(const Image &image, T fillColor, const array<size_type, 2> &origin,
						 const array<size_type, 2> &region, const vector<Event> *events = nullptr,
						 Event *event = nullptr) const {
			return enqueueFillImage(image,
									fillColor,
									{origin[0], origin[1], 0},
									{region[0], region[1], 1},
									events,
		...
		cl_int enqueueCopyImageToBuffer(const Image &src, const Buffer &dst,
										const array<size_type, 2> &src_origin,
										const array<size_type, 2> &region, size_type dst_offset,
										const vector<Event> *events = nullptr,
										Event *event				= nullptr) const {
			return enqueueCopyImageToBuffer(src,
											dst,
											{src_origin[0], src_origin[1], 0},
											{region[0], region[1], 1},
											dst_offset,
		...
		cl_int enqueueCopyBufferToImage(const Buffer &src, const Image &dst, size_type src_offset,
										...
										const vector<Event> *events = nullptr,
										Event *event				= nullptr) const {
			return enqueueCopyBufferToImage(src,
											dst,
											src_offset,
											{dst_origin[0], dst_origin[1], 0},
											{region[0], region[1], 1},
		...
		void *enqueueMapBuffer(const Buffer &buffer, cl_bool blocking, cl_map_flags flags,
			...
			if (err != nullptr) { *err = error; }
			if (event != nullptr && error == CL_SUCCESS) *event = tmp;

			return result;
		}

		void *enqueueMapImage(const Image &image, cl_bool blocking, cl_map_flags flags,
		...
		void *enqueueMapImage(const Image &image, cl_bool blocking, cl_map_flags flags,
							  const array<size_type, 2> &origin, const array<size_type, 2> &region,
							  size_type *row_pitch, size_type *slice_pitch,
							  const vector<Event> *events = nullptr, Event *event = nullptr,
							  cl_int *err = nullptr) const {
			return enqueueMapImage(image,
								   blocking,
								   flags,
								   {origin[0], origin[1], 0},
								   {region[0], region[1], 1},
		...
		/**
		 * Enqueues a command that copies a region of memory from the source pointer to the
		 * destination pointer. This function is specifically for transferring data between the host
		 * and a coarse-grained SVM buffer.
		 */
		template<typename T>
		cl_int enqueueMemcpySVM(T *dst_ptr, const T *src_ptr, cl_bool blocking, size_type size,
								const vector<Event> *events = nullptr,
								Event *event				= nullptr) const {
			cl_event tmp;
			cl_int err = detail::errHandler(
		 ...
		 *This function takes two cl::pointer instances representing the destination and source
		 *buffers.
		 */
		template<typename T, class D>
		cl_int enqueueMemcpySVM(cl::pointer<T, D> &dst_ptr, const cl::pointer<T, D> &src_ptr,
								cl_bool blocking, size_type size,
								const vector<Event> *events = nullptr,
								Event *event				= nullptr) const {
			cl_event tmp;
			cl_int err = detail::errHandler(
		...
		cl_int enqueueMemcpySVM(cl::vector<T, Alloc> &dst_container,
								const cl::vector<T, Alloc> &src_container, cl_bool blocking,
								const vector<Event> *events = nullptr,
								Event *event				= nullptr) const {
			cl_event tmp;
		...
		cl_int enqueueMemFillSVM(cl::pointer<T, D> &ptr, PatternType pattern, size_type size,
								 const vector<Event> *events = nullptr,
								 Event *event				 = nullptr) const {
			cl_event tmp;
			cl_int err = detail::errHandler(
		...
		/**
		 * Enqueues a command that will allow the host to fill a region of a coarse-grained SVM
		 * buffer with a specified pattern. This variant takes a cl::vector instance.
		 */
...
#if CL_HPP_TARGET_OPENCL_VERSION >= 200
		/**
		 * Enqueues a command that will release a coarse-grained SVM buffer back to the OpenCL
		 * runtime. This variant takes a raw SVM pointer.
		 */
		template<typename T>
		...
		/**
		 * Enqueues a command that will release a coarse-grained SVM buffer back to the OpenCL
		 * runtime. This variant takes a cl::pointer instance.
		 */
		template<typename T, class D>
		cl_int enqueueUnmapSVM(cl::pointer<T, D> &ptr, const vector<Event> *events = nullptr,
							   Event *event = nullptr) const {
			cl_event tmp;
			cl_int err = detail::errHandler(
			  ::clEnqueueSVMUnmap(
		...
		/**
		 * Enqueues a command that will release a coarse-grained SVM buffer back to the OpenCL
		 * runtime. This variant takes a cl::vector instance.
		 */
		template<typename T, class Alloc>
		...
		template<typename T>
		cl_int
		enqueueMigrateSVM(const cl::vector<T *> &svmRawPointers, const cl::vector<size_type> &sizes,
						  cl_mem_migration_flags flags = 0, const vector<Event> *events = nullptr,
						  Event *event = nullptr) const {
			cl_event tmp;
			cl_int err = detail::errHandler(
		...
		template<typename T>
		cl_int
		enqueueMigrateSVM(const cl::vector<T *> &svmRawPointers, cl_mem_migration_flags flags = 0,
						  const vector<Event> *events = nullptr, Event *event = nullptr) const {
		...
		template<typename T, class D>
		cl_int
		enqueueMigrateSVM(const cl::vector<cl::pointer<T, D>> &svmPointers,
		...
		enqueueTask(const Kernel &kernel, const vector<Event> *events = nullptr,
 ...
 */
		...
		cl_int enqueueMarker(Event *event = nullptr) const CL_API_SUFFIX__VERSION_1_1_DEPRECATED {
			cl_event tmp;
			cl_int err =
			  detail::errHandler(::clEnqueueMarker(object_, (event != nullptr) ? &tmp : nullptr),
		...
		cl_int enqueueWaitForEvents(const vector<Event> &events) const
		  CL_API_SUFFIX__VERSION_1_1_DEPRECATED {
			return detail::errHandler(::clEnqueueWaitForEvents(object_,
															   (cl_uint)events.size(),
															   events.size() > 0
 ...
 */
...
#ifdef cl_khr_external_memory
		cl_int enqueueAcquireExternalMemObjects(const vector<Memory> &mem_objects,
		...
		cl_int enqueueReleaseExternalMemObjects(const vector<Memory> &mem_objects,
												const vector<Event> *events_wait = nullptr,
												Event *event					 = nullptr) {
			cl_int err = CL_INVALID_OPERATION;
			cl_event tmp;
...
#ifdef cl_khr_semaphore
		cl_int enqueueWaitSemaphores(const vector<Semaphore> &sema_objects,
									 const vector<cl_semaphore_payload_khr> &sema_payloads = {},
									 const vector<Event> *events_wait_list = nullptr,
									 Event *event						   = nullptr) const;

		cl_int enqueueSignalSemaphores(const vector<Semaphore> &sema_objects,
									   const vector<cl_semaphore_payload_khr> &sema_payloads = {},
									   const vector<Event> *events_wait_list = nullptr,
									   Event *event							 = nullptr);
#endif // cl_khr_semaphore
...
#	if CL_HPP_TARGET_OPENCL_VERSION >= 210
		...
		static DeviceCommandQueue updateDefault(const Context &context, const Device &device,
			...
			cl_int error;
			error =
			  clSetDefaultDeviceCommandQueue(context.get(), device.get(), default_queue.get());
...
#	endif // #if CL_HPP_TARGET_OPENCL_VERSION >= 210
	...
	inline cl_int enqueueMapSVM(T *ptr, cl_bool blocking, cl_map_flags flags, size_type size,
		...
		cl_int error;
		CommandQueue queue = CommandQueue::getDefault(&error);
		if (error != CL_SUCCESS) { return detail::errHandler(error, __ENQUEUE_MAP_SVM_ERR); }
	...
	inline cl_int enqueueMapSVM(cl::vector<T, Alloc> &container, cl_bool blocking,
								cl_map_flags flags, const vector<Event> *events = nullptr,
								Event *event = nullptr) {
		cl_int error;
		CommandQueue queue = CommandQueue::getDefault(&error);
		if (error != CL_SUCCESS) { return detail::errHandler(error, __ENQUEUE_MAP_SVM_ERR); }
	...
	inline cl_int enqueueUnmapSVM(T *ptr, const vector<Event> *events = nullptr,
		...
		cl_int error;
		CommandQueue queue = CommandQueue::getDefault(&error);
		if (error != CL_SUCCESS) { return detail::errHandler(error, __ENQUEUE_UNMAP_SVM_ERR); }
	 ...
	 */
	template<typename T, class D>
	inline cl_int enqueueUnmapSVM(cl::pointer<T, D> &ptr, const vector<Event> *events = nullptr,
								  Event *event = nullptr) {
		cl_int error;
		CommandQueue queue = CommandQueue::getDefault(&error);
		if (error != CL_SUCCESS) { return detail::errHandler(error, __ENQUEUE_UNMAP_SVM_ERR); }
	...
	inline cl_int enqueueReadBufferRect(const Buffer &buffer, cl_bool blocking,
										...
										size_type host_row_pitch, size_type host_slice_pitch,
	...
	inline cl_int enqueueWriteBufferRect(const Buffer &buffer, cl_bool blocking,
										 ...
										 size_type buffer_row_pitch, size_type buffer_slice_pitch,
										 size_type host_row_pitch, size_type host_slice_pitch,
										 const void *ptr, const vector<Event> *events = nullptr,
										 Event *event = nullptr) {
		cl_int error;
		CommandQueue queue = CommandQueue::getDefault(&error);
	...
	inline cl_int enqueueCopyBufferRect(
	  ...
	  size_type dst_slice_pitch, const vector<Event> *events = nullptr, Event *event = nullptr) {
		cl_int error;
		CommandQueue queue = CommandQueue::getDefault(&error);
	...
	public:
		...
		EnqueueArgs(CommandQueue &queue, const vector<Event> &events, NDRange global,
					NDRange local) :
				queue_(queue),
				offset_(NullRange), global_(global), local_(local), events_(events) {}

		EnqueueArgs(CommandQueue &queue, const vector<Event> &events, NDRange offset,
					NDRange global, NDRange local) :
				queue_(queue),
				offset_(offset), global_(global), local_(local), events_(events) {}
	};
...
#	endif // cl_khr_external_semaphore
	...
	public:
		...
		Semaphore(const Context &context, const vector<cl_semaphore_properties_khr> &sema_props,
				  cl_int *err = nullptr) {
			...
			if (pfn_clCreateSemaphoreWithPropertiesKHR) {
				object_ =
				  pfn_clCreateSemaphoreWithPropertiesKHR(context(), sema_props.data(), &error);
			}
...
#	ifdef cl_khr_external_semaphore
		template<typename T>
		cl_int getHandleForTypeKHR(const Device &device, cl_external_semaphore_handle_type_khr name,
								   T *param) const {
...
#	endif // cl_khr_external_semaphore
	...
	inline cl_int
	CommandQueue::enqueueWaitSemaphores(const vector<Semaphore> &sema_objects,
										const vector<cl_semaphore_payload_khr> &sema_payloads,
		...
		if (pfn_clEnqueueWaitSemaphoresKHR != nullptr) {
			err = pfn_clEnqueueWaitSemaphoresKHR(
			  ...
			  (events_wait_list != nullptr && events_wait_list->size() > 0)
				? (cl_event *)&events_wait_list->front()
				: nullptr,
			  (event != nullptr) ? &tmp : nullptr);
		}
	...
	inline cl_int
	CommandQueue::enqueueSignalSemaphores(const vector<Semaphore> &sema_objects,
										  const vector<cl_semaphore_payload_khr> &sema_payloads,
	...
	public:
		...
		explicit CommandBufferKhr(const vector<CommandQueue> &queues,
			...
			if (errcode_ret != nullptr) { *errcode_ret = error; }
		}
		...
		cl_int
		commandBarrierWithWaitList(const vector<cl_sync_point_khr> *sync_points_vec = nullptr,
			...
			if (sync_point != nullptr && error == CL_SUCCESS) *sync_point = tmp_sync_point;

			return error;
		}

		cl_int commandCopyBuffer(const Buffer &src, const Buffer &dst, size_type src_offset,
								 size_type dst_offset, size_type size,
		...
		cl_int commandCopyBufferRect(
		  ...
		  const array<size_type, 3> &dst_origin, const array<size_type, 3> &region,
		  size_type src_row_pitch, size_type src_slice_pitch, size_type dst_row_pitch,
		  size_type dst_slice_pitch, const vector<cl_sync_point_khr> *sync_points_vec = nullptr,
		  cl_sync_point_khr *sync_point = nullptr, MutableCommandKhr *mutable_handle = nullptr,
		  const CommandQueue *command_queue = nullptr) {
		...
		cl_int commandCopyBufferToImage(const Buffer &src, const Image &dst, size_type src_offset,
										const array<size_type, 3> &dst_origin,
										const array<size_type, 3> &region,
										const vector<cl_sync_point_khr> *sync_points_vec = nullptr,
										cl_sync_point_khr *sync_point					 = nullptr,
		...
		cl_int commandCopyImage(const Image &src, const Image &dst,
								const array<size_type, 3> &src_origin,
								const array<size_type, 3> &dst_origin,
								const array<size_type, 3> &region,
								const vector<cl_sync_point_khr> *sync_points_vec = nullptr,
		...
		cl_int commandCopyImageToBuffer(const Image &src, const Buffer &dst,
										const array<size_type, 3> &src_origin,
										const array<size_type, 3> &region, size_type dst_offset,
										const vector<cl_sync_point_khr> *sync_points_vec = nullptr,
										cl_sync_point_khr *sync_point					 = nullptr,
		...
		template<typename PatternType>
		cl_int commandFillBuffer(const Buffer &buffer, PatternType pattern, size_type offset,
								 size_type size,
								 const vector<cl_sync_point_khr> *sync_points_vec = nullptr,
								 cl_sync_point_khr *sync_point					  = nullptr,
								 MutableCommandKhr *mutable_handle				  = nullptr,
		...
		cl_int commandFillImage(const Image &image, cl_float4 fillColor,
								const array<size_type, 3> &origin,
								const array<size_type, 3> &region,
								const vector<cl_sync_point_khr> *sync_points_vec = nullptr,
								cl_sync_point_khr *sync_point					 = nullptr,
		...
		cl_int
		commandNDRangeKernel(const cl::vector<cl_ndrange_kernel_command_properties_khr> &properties,

...
if platform.system() == "Windows":
    # Copy DLLs to openblas_install
    if os.path.exists(os.path.join("src", "librapid", "openblas_install")):
        shutil.copyfile("bin/flang.dll", os.path.join("src", "librapid", "openblas_install", "flang.dll"))
        shutil.copyfile("bin/flangrti.dll", os.path.join("src", "librapid", "openblas_install", "flangrti.dll"))
        shutil.copyfile("bin/libomp.dll", os.path.join("src", "librapid", "openblas_install", "libomp.dll"))
        shutil.copyfile("bin/pgmath.dll", os.path.join("src", "librapid", "openblas_install", "pgmath.dll"))
    
    if os.path.exists(os.path.join("src", "librapid", "blas")):
        shutil.copyfile("bin/flang.dll", os.path.join("src", "librapid", "blas", "flang.dll"))
        shutil.copyfile("bin/flangrti.dll", os.path.join("src", "librapid", "blas", "flangrti.dll"))
        shutil.copyfile("bin/libomp.dll", os.path.join("src", "librapid", "blas", "libomp.dll"))
        shutil.copyfile("bin/pgmath.dll", os.path.join("src", "librapid", "blas", "pgmath.dll"))
    ...
    for filename in dll_files:
        try:
            ...
            with open(os.path.join("src", "librapid", "blas", filename), "r") as _:
                files.append(os.path.join("src", "librapid", "blas", filename))
    ...
    for filename in dll_files:
        try:
            ...
            with open(os.path.join("src", "librapid", "openblas_install", "bin", filename), "r") as _:
                files.append(os.path.join("src", "librapid", "openblas_install", "bin", filename))
